...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--checkpoint_path', default="psp_ffhq_encode.pt", type=str, help='Path to pSp model checkpoint')
		...
		self.parser.add_argument('--resize_outputs', action='store_true', default=True, help='Whether to resize outputs to 256x256 or keep at 1024x1024')
		...
		self.parser.add_argument('--latent_mask', type=str, default="5,6,7,8,9", help='Comma-separated list of latents to perform style-mixing with')
